...
public class NotificationAdminController {
    ...
    @PostMapping
    public ResponseEntity<?> sendGlobalNotification(@RequestBody @Valid SystemNotificationRequest request) {
    ...
    public ResponseEntity<?> editGlobalNotification(@RequestBody SystemNotificationRequest request, @PathVariable Long notificationId) {
    ...
    public ResponseEntity<?> deleteGlobalNotification(@PathVariable Long notificationId) {
